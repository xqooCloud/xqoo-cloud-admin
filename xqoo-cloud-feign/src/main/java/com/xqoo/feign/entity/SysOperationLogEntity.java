...
public class SysOperationLogEntity extends Model<SysOperationLogEntity> {
    ...
    private static final long serialVersionUID = -4089797794748807502L;
    ...
    @ApiModelProperty("操作异常提示信息，不超过256字")
    ...
    public String toString() {
        return "SysOperationLogEntity{" +
                ...
                ", operatorErrorMessage='" + operatorErrorMessage + '\'' +
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(logId, that.logId) &&
                ...
                Objects.equals(operatorErrorMessage, that.operatorErrorMessage) &&
    ...
    public void setOperatorErrorMessage(String operatorErrorMessage) {
        this.operatorErrorMessage = operatorErrorMessage;
    }
