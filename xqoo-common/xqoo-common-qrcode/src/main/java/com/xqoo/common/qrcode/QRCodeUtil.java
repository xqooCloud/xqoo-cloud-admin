...
//        	bitMatrix = deleteWhite(bitMatrix);
    ...
    public static BufferedImage generateQRImageBufferedImg(String txt, String imgPath, String imgName, String suffix) {
        File filePath = new File(imgPath);
        if (!filePath.exists()) {
            filePath.mkdirs();
        }
...
//        	bitMatrix = deleteWhite(bitMatrix);
    ...
    /**
     *
     * 功能描述: 生成二维码图片（大小由传入参数决定）
     *
     */
    public static BufferedImage generateQRImageBufferedImg(String txt, String imgPath, String imgName, String suffix,int width, int height) {
        File filePath = new File(imgPath);
        if (!filePath.exists()) {
            filePath.mkdirs();
        }
