package com.xqoo.common.redis.aspect;

import com.xqoo.common.redis.annotation.RedisCache;
import com.xqoo.common.redis.annotation.RedisEvict;
...
public class RedisAspect
{
    ...
    *//**
     ...
     *//*
    @Pointcut("@annotation(com.xqoo.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.xqoo.common.redis.annotation.RedisEvict)")
    ...
    public Object WriteReadFromRedis(ProceedingJoinPoint point)
    {
        try
        {
            ...
            if (redisCache != null && redisCache.read())
            {
                ...
                String obj = valueOperations.get(rk);
                if (obj == null)
                {
                    ...
                    if (obj != null)
                    {
                        ...
                        {
                            valueOperations.set(rk, obj, redisCache.expired());
                        }
                        else
                        {
                            valueOperations.set(rk, obj);
                        }
                    }
                }
                return obj;
