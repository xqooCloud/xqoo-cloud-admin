 ...
 * 微信支付相关参数bean
 */
public class WxPayPropertiesBean {
    ...
    public boolean equals(Object o) {
        ...
        WxPayPropertiesBean that = (WxPayPropertiesBean) o;
    ...
    public void fromMap(Map<String, String> map){
        this.setAppId(map.getOrDefault("appId", PayConfigInitConstant.WxPayConfigDefult.APPID));
        this.setAppAppId(map.getOrDefault("appAppId", PayConfigInitConstant.WxPayConfigDefult.APP_APPID));
        this.setOaAppId(map.getOrDefault("oaAppId", PayConfigInitConstant.WxPayConfigDefult.OA_APPID));
        this.setSpAppId(map.getOrDefault("spAppId", PayConfigInitConstant.WxPayConfigDefult.SP_APPID));
        this.setMchId(map.getOrDefault("mchId", PayConfigInitConstant.WxPayConfigDefult.MCHID));
        this.setFeeType(map.getOrDefault("feeType", PayConfigInitConstant.WxPayConfigDefult.FEE_TYPE));
        this.setSpbillCreateIp(map.getOrDefault("spbillCreateIp", PayConfigInitConstant.WxPayConfigDefult.SPBILL_CREATE_IP));
        this.setNotifyUrl(map.getOrDefault("notifyUrl", PayConfigInitConstant.WxPayConfigDefult.NOTIFY_URL));
        this.setTradeType(map.getOrDefault("tradeType", PayConfigInitConstant.WxPayConfigDefult.TRADE_TYPE));
        this.setApiKey(map.getOrDefault("apiKey", PayConfigInitConstant.WxPayConfigDefult.API_KEY));
        this.setGatewayUrl(map.getOrDefault("gatewayUrl", PayConfigInitConstant.WxPayConfigDefult.GATEWAY_URL));
        this.setRefundGatewayUrl(map.getOrDefault("refundGatewayUrl", PayConfigInitConstant.WxPayConfigDefult.REFUND_GATEWAY_URL));
        this.setSslPath(map.getOrDefault("sslPath", PayConfigInitConstant.WxPayConfigDefult.SSL_PATH));
        this.setSslPassword(map.getOrDefault("sslPassword", PayConfigInitConstant.WxPayConfigDefult.SSL_PASSWORD));
        this.setPayToPersonalGateway(map.getOrDefault("payToPersonalGateway", PayConfigInitConstant.WxPayConfigDefult.PAY_TO_PERSONAL_GATEWAY));
        this.setIp(map.getOrDefault("ip", PayConfigInitConstant.WxPayConfigDefult.IP));
        this.setPcMchKey(map.getOrDefault("pcMchKey", PayConfigInitConstant.WxPayConfigDefult.PC_MCH_KEY));
        this.setAppMchKey(map.getOrDefault("appMchKey", PayConfigInitConstant.WxPayConfigDefult.APP_MCH_KEY));
        this.setOaMchKey(map.getOrDefault("oaMchKey", PayConfigInitConstant.WxPayConfigDefult.OA_MCH_KEY));
        this.setSpMchKey(map.getOrDefault("spMchKey", PayConfigInitConstant.WxPayConfigDefult.SP_MCH_KEY));
        this.setSubject(map.getOrDefault("subject", PayConfigInitConstant.WxPayConfigDefult.SUBJECT));
    }
}
