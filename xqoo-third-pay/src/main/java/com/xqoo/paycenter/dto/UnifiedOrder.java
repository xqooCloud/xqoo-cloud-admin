...
public class UnifiedOrder extends WeixinPaySignablePdu {
    ...
    public UnifiedOrder setTime_startByDate(Date time_start) {
        this.time_start = WxPayAbsUtil.toWeixinDateFormat(time_start);
        return this;
    }
    ...
    public Date getTime_startAsDate() {
        return WxPayAbsUtil.fromWeixinDateFormat(time_start);
    }

    @JsonIgnore
    public Date getTime_expireAsDate() {
        return WxPayAbsUtil.fromWeixinDateFormat(time_expire);
    }
    ...
    public UnifiedOrder setTime_expireByDate(Date time_expire) {
        this.time_expire = WxPayAbsUtil.toWeixinDateFormat(time_expire);
        return this;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this)
                ...
                .append("time_start", time_start)
                .append("time_expire", time_expire)
                .append("goods_tag", goods_tag)
